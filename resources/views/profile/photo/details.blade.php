    ...
    @if($photo)
        <div class="callout primary">
            <article class="grid-container">
                <div class="">
                    <p><a href="{{url('/')}}/profile/gallery/show/{{$photo->gallery_id}}"><i class="fa fa-arrow-circle-left"></i> Back to Portfolio Gallery</a></p>
                ...
                <div class="cell">
                    <div class="callout">
                        <div class="float-right">
                            <a href="{{url('/')}}/profile/photo/edit/{{$photo->id}}"><button class="button"><i class="fa fa-edit"></i> Edit</button></a>
                            <a href="{{url('/')}}/profile/photo/destroy/{{$photo->id}}/{{$photo->gallery_id}}" onclick="return confirm('Are you sure to delete?')"><button class="button bg-danger margin-0"><i class="fa fa-trash"></i> Delete</button></a>
                        </div>
                        <h4>{{$photo->title}}</h4>
                        @if($owner)
