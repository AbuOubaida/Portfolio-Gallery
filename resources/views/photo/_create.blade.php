...
@section('content')
    <div class="callout primary">
        <article class="grid-container">
            <div class="">
                <p><a href="{{url('/')}}/gallery/show/{{$project->id}}"><i class="fa fa-arrow-circle-left"></i> Back to {{$project->name}} Project</a></p>
                <h1>Upload Portfolio</h1>
                <p class="lead">Upload the Portfolio photo to make gallery for your {{$project->name}} project</p>
            </div>
        </article>
    </div>
    <article class="grid-container">
